...
// var SetQuestbox = document.querySelector("#questbox");
// var setQuestionary = document.querySelector("#questionary");
// var SetButton1 = document.querySelector("#button1");
// var SetButton2 = document.querySelector("#button2");
// var SetButton3 = document.querySelector("#button3");
// var SetButton4 = document.querySelector("#button4");
...
var questionsArr = [
	...
	{
		question           : 'The condition in an if/else is enclosed with ________',
		answers            : [
			'quotes',
			'curly brackets',
			'parenthesis',
...
function highScoresPage(scorepage) {
	...
	scorepage.appendChild(highScoresContainerEl);
}
